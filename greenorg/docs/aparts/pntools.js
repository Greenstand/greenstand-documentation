//---------------------------
var pn=(pn ? pn : {}); 
pn.version=220123; pn.basedir="./"; pn.ready=false;
//alert('pn.ready: '+pn.ready);
...
pn.loglocal=false; try{pn.loglocal=CONFIG.tobrowser;} catch(e){pn.loglocal=false;}
pn.logremote=true; try{pn.logremote=CONFIG.toserver;} catch(e){pn.logremote=true;}
...
pn.init=function(){
  ...
  window.scrollTo(0,0);
  //pn.rsrch();
  if(!pn.debug){pn.ready=true;return;}
...
pn.cookieEnd=function(days){
  ...
  exp=exp.toGMTString();
  return '; expires='+exp+'; path=/;secure;samesite=Strict;';
}//cookieEnd
